// File: lib/models/planning_demand_model.dart

class PlanningDemandModel {
  final String id; // activityId_year_orgUnitId
  ...
  factory PlanningDemandModel.fromMap(Map<String, dynamic> map) =>
      PlanningDemandModel(
        id: map['id'] ?? '',
